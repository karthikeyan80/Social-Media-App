...
CREATE TABLE "Follows" (
    "folllowerId" TEXT NOT NULL,
    "followingId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "Follows_pkey" PRIMARY KEY ("folllowerId","followingId")
);
...
-- CreateIndex
CREATE INDEX "Follows_folllowerId_followingId_idx" ON "Follows"("folllowerId", "followingId");
...
-- AddForeignKey
ALTER TABLE "Follows" ADD CONSTRAINT "Follows_folllowerId_fkey" FOREIGN KEY ("folllowerId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
